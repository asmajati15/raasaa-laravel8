...
<div class="container">
  <div class="row pb-4">
    <div class="col-lg-8">
      <h2 class="my-4">Form Tambah Kategori Menu</h2>
      ...
      <form action="/web-raasaa-admin/type" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <select id="Select" class="form-select @error('filters_id') is-invalid @enderror" id="filters_id" required name="filters_id">
        ...
        <button type="submit" class="btn btn-primary">Tambah Kategori Menu</button>
